...
#define Initial_condition_fname "Ninit_chol_la.d"
...
double	Total_transmembrane_currents(state_variables &rN, const double &Ist);
...
FILE* initcond = fopen(Initial_condition_fname,"r");
if(initcond == NULL)
{
	throw;
}
